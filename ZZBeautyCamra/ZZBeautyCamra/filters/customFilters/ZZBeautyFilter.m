...
NSString *const kZZBeautyFragmentShaderString = SHADER_STRING(
...
@implementation ZZBeautyFilter

- (id)init
{
    if(!(self = [super initWithFragmentShaderFromString:kZZBeautyFragmentShaderString])){
        return nil;
    }
    _toneLevel = 0.7;
    _beautyLevel = 0.8;
